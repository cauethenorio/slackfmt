  ...
  ({ value, onChange, onPaste }, ref) => {
    ...
    return (
      <textarea
        ...
        spellCheck={false}
        className="w-full h-full resize-none bg-transparent text-text-secondary font-mono text-sm leading-relaxed p-5 pb-16 outline-none placeholder:text-text-subtle"
      />
    );
  },
);
